...
macro(Ubpa_InitTestSwitch)
	set(Ubpa_BuildTest OFF CACHE BOOL OFF)
endmacro()
...
function(Ubpa_AddNatvis)
	...
	set(CONFIG_UCMAKE_NATVIS "<!-- \n    Generated by UCMake v${UCMake_VERSION} for natvis\n    Any changes to this file will be overwritten by the next CMake run\n-->")
...
function(Ubpa_GroupSrcs)
	...
	set(shaderFiles ${ARG_SOURCES})
	list(FILTER shaderFiles INCLUDE REGEX ".+\.(vert|tesc|tese|geom|frag|comp|hlsl)$")
	...
	foreach(shaderFile ${shaderFiles})
		get_filename_component(shaderFilePath "${shaderFile}" PATH)
		file(RELATIVE_PATH shaderFilePathRel ${ARG_PATH} "${shaderFilePath}")
		if(MSVC)
			string(REPLACE "/" "\\" shaderFilePathRelMSVC "${shaderFilePathRel}")
			set(shaderFilePathRel "Qt Files\\${qtFilePathRelMSVC}")
		endif()
		source_group("${shaderFilePathRel}" FILES "${shaderFile}")
	endforeach()
endfunction()
...
function(Ubpa_AddTarget_GDR)
	...
	if("${ARG_TEST}" STREQUAL "ON" AND "${Ubpa_BuildTest}" STREQUAL "OFF")
		return()
	endif()
	...
	list(LENGTH ARG_PUBLIC_GLIBS publicLibNum)
	if(${debugLibNum} EQUAL 0 AND ${releaseLibNum} EQUAL 0 AND ${publicLibNum} EQUAL 0)
		...
		Ubpa_List_Print(STRS ${ARG_LIBS_RELEASE}
			TITLE  "  - release:"
			PREFIX "      ")
		Ubpa_List_Print(STRS ${ARG_PUBLIC_GLIBS}
			TITLE  "  - public:"
			PREFIX "      ")
		Ubpa_List_Print(STRS ${ARG_INC_DIRS}
			TITLE "  - dirs:"
			PREFIX "      ")
	endif()
